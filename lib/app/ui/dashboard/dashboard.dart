                            ...
                            child: Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Image.network(
                                          '${snapshot.data}/api/HCMMobileApp/Employee/Image?o=1&f=2.PNG',
                                          headers: {"Authorization":"${Session.current().tokenType} ${Session.current().accessToken}"},
                                      width: 175,
                                      height: 133,
                                      fit: BoxFit.cover,
                                    ),
                                  ...
                                  LayoutBuilder(builder: (context, constraints) {
                                    return SizedBox(
                                        ...
                                        child: ListView.builder(
                                            itemCount:
                                                eventsNotifier.getData()?.length,
                                            shrinkWrap: true,
                                            itemBuilder: (context, index) {
                                              var data =
                                                  (eventsNotifier.getData() ??
                                                      [])[index];
                                              return Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  LayoutBuilder(builder: (context, constrints) {
                                    return SizedBox(
                                      height:
                                          constrints.maxWidth * (188 / 191) - 82,
                                      child: ListView.builder(
                                          itemCount: leaveBalanceNotifier
                                              .getData()
                                              ?.length,
                                          shrinkWrap: true,
                                          itemBuilder: (context, index) {
                                            var balances =
                                                leaveBalanceNotifier.getData() ??
                                                    [];
                                ...
                                children: [
                                  ...
                                  LayoutBuilder(builder: (context, constrints) {
                                    return SizedBox(
                                      ...
                                      child: ListView.builder(
                                          itemCount:
                                              policyNotifier.getData()?.length,
                                          shrinkWrap: true,
                                          itemBuilder: (context, index) {
                                            var data = (policyNotifier.getData() ??
                                                [])[index];
                                            return Row(children: [
                                              Expanded(
                                                child: Center(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Image.network(
                                    "${snapshot.data}/assets/images/salarySlip.jpg",
                                  ),
                                )),
                                TextButton(
                                  onPressed: () {},
